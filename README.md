...
[![Website](https://img.shields.io/badge/Live-Online-blue)](https://aman-singh-ai-linktree.vercel.app)
[![Made with HTML/CSS/JS](https://img.shields.io/badge/Frontend-HTML%20%2F%20CSS%20%2F%20JS-brightgreen)](https://github.com)
...
```mermaid
flowchart LR
    A[Aman Singh Profile] --> B[Portfolio]
    A --> C[GitHub]
    A --> D[LinkedIn]
    A --> E[Google Skills]
    A --> F[Google Developers]
    A --> G[Credly]
    A --> H[Instagram]
    A --> I[WhatsApp]
    A --> J[Telegram]
